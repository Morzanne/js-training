[![Build Status](https://travis-ci.org/nan-academy/js-training.svg?branch=master)](https://travis-ci.org/Morzanne/js-training)
## Setup
First, [**fork**](https://github.com/Morzanne/js-training/fork?fragment=1) this repository.
